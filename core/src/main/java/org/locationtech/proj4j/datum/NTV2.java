 ...
 * - only files with 1 subfile are supported
 * - gridshift type is supposed to be in seconds
 * - only little-endian is supported ("Australian"-NTv2, as opposed to "Canadian")
 *
 * Header structure:
 * <pre>
 * 0        8        16
...
public final class NTV2 {
	...
	public static void load(DataInputStream definition, Grid grid) throws IOException {
		...
		definition.skipNBytes(HEADER_SIZE + SUB_HEADER_SIZE);
